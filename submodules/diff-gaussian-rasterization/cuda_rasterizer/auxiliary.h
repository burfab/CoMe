...
#define OCCUPATION_OFFSET 13
#define OCCUPATION2_OFFSET 14
#define EXTRA_FEATURES_OFFSET 15
#define OUTPUT_CHANNELS_DEFAULT 15
...
//default is 255
#define ALPHA_THRESHOLD_INV (255.f)
