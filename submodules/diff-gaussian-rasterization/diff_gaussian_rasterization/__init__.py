...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            num_rendered, color, radii, max_weights, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, max_weights

    @staticmethod
    def backward(ctx, grad_out_color, ignored_1, ignored_2):
